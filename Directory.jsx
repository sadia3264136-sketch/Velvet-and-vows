  ...
  return (
    <div className="bg-canvas-dark min-h-screen flex flex-col">
      <SEO
        ...
        description="Search vetted event planners, wedding stylists, and gala curators by budget, event type, and city."
        path="/planners"
      />
      <Navbar />
          ...
          {filtered.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {filtered.map((p) => (
                ...
                >
                  <div className="h-40 bg-surface-elevated-dark overflow-hidden">
                    <img
                      src={images[`planner:${p.id}`] || plannerImages[p.id]}
                      alt={p.name}
                      loading="lazy"
